...
function hal(){
    ...
    adb push $ANDROID_PRODUCT_OUT/vendor/lib64/sensors.native.so /vendor/lib64/
}
...
function cdsp(){
    # cdsp
    adb shell mount -o remount,rw /vendor/firmware_mnt
    adb push $ANDROID_BUILD_TOP/amss_codes/CDSP.VT.1.1/cdsp_proc/obj/qdsp6v5_ReleaseG/660.cdsp.prod/signed/LA/system/etc/firmware/* /vendor/firmware_mnt/image/
}
function selinux(){
    # selinux
    #adb push $ANDROID_PRODUCT_OUT/system/etc/selinux/ /system/etc/
